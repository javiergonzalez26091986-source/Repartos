...
# --- BLOQUE DE SEGURIDAD (ESTILOS Y BLOQUEO DE SALIDA) ---
# El script de JavaScript detecta si el usuario intenta cerrar o recargar y lanza la alerta del navegador
st.markdown("""
    <style>
...
# JavaScript para evitar cierre accidental
html_code = """
<script>
window.onbeforeunload = function() {
    return "¡Atención! Tienes una jornada en curso. Si cierras, podrías perder el hilo de tus entregas. ¿Deseas salir?";
};
</script>
"""
...
with st.sidebar:
    st.info("⚠️ No cierres esta pestaña sin finalizar tu jornada.")
    if st.button("🏁 FINALIZAR DÍA", type="primary"):
        # Limpiamos todo para que pueda salir sin alertas
