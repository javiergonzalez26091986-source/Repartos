...
st.set_page_config(page_title="SERGEM v5.0", layout="wide")

# --- LINK DE IMPLEMENTACIÓN (Asegúrate que sea el último generado) ---
...
# --- BASE DE DATOS DE TIENDAS Y CÓDIGOS ---
TIENDAS_DATOS = {
    'CALI': {
    ...
    'MEDELLÍN': {
        'ÉXITO CIUDAD DEL RIO': '197', 'CARULLA SAO PAULO': '341', 'SURTIMAX CALDAS': '4534'
    },
    'BOGOTÁ': {
        'CARULLA CEDRITOS': '468', 'ÉXITO PLAZA BOLIVAR': '558', 'SURTIMAX BOSA': '311'
    }
}
...
if cedula and nombre:
    if st.session_state['hora_referencia'] == "":
        ...
        # CORRECCIÓN DE EMPRESA SOLICITADA
        ...
        if ciudad != "--":
            ...
            # --- SELECTORES SEPARADOS PARA PANADERÍA ---
        ...
        if info:
            ...
            if st.button("ENVIAR A LA NUBE ✅", use_container_width=True):
                ...
                try:
                    ...
                    st.success("¡Sincronizado! Información enviada al Drive.")
                    st.session_state['hora_referencia'] = h_llegada
                    time.sleep(1.5)
                    st.rerun()
                except:
                    st.warning("El servidor tardó en responder, pero la fila probablemente se creó. Revisa el Drive.")
                    st.session_state['hora_referencia'] = h_llegada
