...
# --- LÓGICA DE PERSISTENCIA POR URL (EL ANCLA) ---
# Al abrir el navegador, esto jala los datos del link automáticamente
...
def actualizar_url():
    """Escribe los datos actuales en la dirección del navegador"""
...
# Si cambian los datos, los anclamos a la URL de inmediato
    ...
    if not st.session_state.hora_ref or st.session_state.hora_ref == "None":
        ...
        if info:
            ...
            if st.button("ENVIAR REGISTRO ✅", use_container_width=True, type="primary"):
                ...
                actualizar_url() # Anclamos la nueva hora base a la URL
